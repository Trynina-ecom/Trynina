  ...
  return (
    <SafeAreaView className="flex-1 bg-Surface" edges={["top"]}>
      ...
      <ScrollView className="flex-1 px-4 mt-4">
          ...
          {/* Payment Section */ }
          <Text text-lg font-bold text-primary mb-4>Payment Method</Text>
      ...
      {/* Order Summary */}
       <View className="p-4 bg-white shadow-lg border-t border-gray-100">
        ...
        {/* Place Order Button */}
        <TouchableOpacity
        className={`p-4 rounded-xl items-center ${loading ? 'bg-gray-400' : 'bg-pink-600'}`} onPress={handlePlaceOrder} disabled={loading}>
