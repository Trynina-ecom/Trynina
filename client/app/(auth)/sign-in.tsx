        ...
        <SafeAreaView className="flex-1 bg-pink-400 justify-center" style={{ padding: 28 }}>
            {!showEmailCode ? (
                <>
                    ...
                    {/* Submit */}
                    <Pressable className={`w-full py-4 rounded-full items-center mb-10 ${loading || !emailAddress || !password ? "bg-Primary" : "bg-primary"}`} onPress={onSignInPress} disabled={loading || !emailAddress || !password}>
